...
class OisStaffProfile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, null=True, related_name='ois_staff_profile')
...
class OisAlumniProfile(models.Model):
    ...
    user = models.OneToOneField(User, on_delete=models.CASCADE, null=True, related_name='ois_alumni_profile') 
...
class OisAlumniGuardianProfile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, null=True, related_name='ois_alumni_guardian_profile')
