...
from cohorts.models.accounts import EmailAddress
from cohorts.utils import get_user_lookup_kwargs
...
class SignupForm(forms.Form):
    ...
    password = PasswordField(
        label=_("Password"),
        strip=settings.COHORTS_PASSWORD_STRIP,
    )
    ...
    def clean_email(self):
        ...
        if not qs.exists() or not settings.COHORTS_EMAIL_UNIQUE:
            return value
